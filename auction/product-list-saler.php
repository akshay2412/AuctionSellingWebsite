...
$Select = "select * from additem where SellerId='".$_SESSION['id']."'";
...
<td><a href="edit-product.php?id=<?php echo $Data['id']?>">[Edit]</a> <a href="productd.php?id=<?php echo $Data['id']?>">[Detail]</a></td>
</tr>
<?php } ?>
</table>
</form>
